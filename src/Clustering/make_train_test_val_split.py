...
with open(dir_path + '\\' + txt_name, 'r', encoding='utf-8') as f_txt,\
    ...
    total = 0
    while True:
        with open(dir_path + '/train_texts.jsonl', 'a', encoding='utf-8') as f_train_txt,\
             open(dir_path + '/train_vec.npy', 'ab') as f_train_vec,\
             open(dir_path + '/test_texts.jsonl', 'a', encoding='utf-8') as f_test_txt,\
             open(dir_path + '/test_vec.npy', 'ab') as f_test_vec,\
             open(dir_path + '/val_texts.jsonl', 'a', encoding='utf-8') as f_val_txt,\
             open(dir_path + '/val_vec.npy', 'ab') as f_val_vec:
            i = 0
