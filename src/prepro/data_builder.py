...
def tokenize(args):
    ...
    command = [
        "java",
        "-jar",
        "/Users/leshanbog/Downloads/stanford-corenlp-full-2018-10-05/stanford-corenlp-3.9.2.jar",
        "-annotators",
        "tokenize,ssplit",
...
class BertData:
    def __init__(self, args):
        ...
        self.tokenizer = BertTokenizer.from_pretrained(
            args.model_path, do_lower_case=True
        )
    ...
    for corpus_path in ["ria.shuffled.test.json"]:
        ...
        with open(args.raw_path + corpus_path, "r", encoding="utf-8") as r:
            for line in r:
                ...
                data = {
                    "src": list(map(word_tokenize, sent_tokenize(clean_text))),
